    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className='flex flex-col space-y-1 mb-8'>
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <input {...field} className='border border-gray-300 w-full h-10 rounded-md text-sm px-3 py-2' placeholder='Enter package name'/>
          )}
        />
      ...
      <div className='flex flex-col space-y-1 mb-8'>
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <textarea {...field} className='border border-gray-300 w-full h-24 rounded-md text-sm px-3 py-2' placeholder='Enter package description'/>
          )}
        />
      ...
      <div className='flex flex-col space-y-1 mb-8'>
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <input type="number" {...field} className='border border-gray-300 w-full h-10 rounded-md text-sm px-3 py-2' min={1}/>
          )}
        />
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
          <div className='relative'>
            <input
              ...
              id="image-upload"
            />
            <label htmlFor="image-upload" className='flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-lg cursor-pointer hover:border-black/50 transition-colors'>
          ...
          <div className='relative'>
            <input
              ...
              id="video-upload"
            />
            <label htmlFor="video-upload" className='flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-lg cursor-pointer hover:border-black/50 transition-colors'>
